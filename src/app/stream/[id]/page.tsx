    ...
    const initializeConnection = async () => {
      try {
        ...
        peer.on('open', (id) => {
          ...
          // Call the broadcaster without providing any stream
          const dummyStream = new MediaStream();
          const call = peer.call(streamId as string, dummyStream);
          callRef.current = call;
          ...
          // Set up data connection for receiving transcription
          const dataConnection = peer.connect(streamId as string);
